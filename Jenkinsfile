    ...
    stages {
        ...
        stage('SCA with Dependency-Check') {
            steps {
                ...
                bat '"C:\\Users\\Abdelaziz\\Desktop\\dependency-check-10.0.2-release\\dependency-check\\bin\\dependency-check.bat" --project "demo" --scan . --format HTML --out dependency-check-report.html --nvdApiKey 181c8fc5-2ddc-4d15-99bf-764fff8d50dc --disableAssembly'
            }
        }
